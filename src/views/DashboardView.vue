                        ...
                        <form action="#" method="GET" class="w-full max-w-lg">
                            ...
                            <div class="mt-0 relative">
                                ...
                                <input type="text" name="email" id="topbar-search"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring focus focus:ring-cyan-600 focus:border-cyan-600 block w-full pl-10 p-2.5"
                                    placeholder="Search">
                            </div>
                        </form>
                    </div>
